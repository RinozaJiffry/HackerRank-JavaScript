...
it throws an exception. We then catch the exception and print its message, which is s.split is not a function. Next, we finally print s  
which, because it wasn't able to be reversed, is Number(1234).
**/
